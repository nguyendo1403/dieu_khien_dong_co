...
while (True):
    ...
    if elapsed_time >= 1:
        ...
        # # client = ModbusClient(method='rtu', port='/dev/ttyUSB0', stopbits=1, parity='N', baudrate=19200)
        # builder1 = BinaryPayloadBuilder(byteorder=Endian.Big, wordorder=Endian.Big)
        # builder1.reset()
        # builder1.add_16bit_int(int(v11))
        # payload1 = builder1.to_registers()
        ...
        # builder2.add_16bit_int(int(v22))
        # payload2=builder2.to_registers()
        # w2_3 = client.write_register(0x30, payload2[0],unit=0x02)
    
        # if (v11==0) and (v22==0):
        #     w1_3 = client.write_register(0x30, 0,unit=0x01)
        #     w2_3 = client.write_register(0x30, 0,unit=0x02)
        
        # print("done gui du lieu",v11,v22)
        ...
        # xungdc1 = abs(r1_3_2 - r1_3_1) #xung của động cơ 1 sau các khoảng thời gian đọc được
        # print("xungdc1 sau mot khoang thoi gian la :",xungdc1)           
        # r1_3_1 = r1_3_2
        

        # #đọc giá trị xung tiếp theo cho động cơ 2
        # readxungdc2 = client.read_holding_registers(0x04,2,unit=0x02)
        # r2_1 = str(hex(readxungdc2.registers[int(0)]))
        # r2_2 = str(hex(readxungdc2.registers[int(1)]))
        # r2_1 = r2_1[2:]
        ...
        # if len(r2_2) == 3:
        #     r2_2 = "0" + r2_2
        # r2_3_2=int(r2_2 + r2_1,base=16)
        # xungdc2 = abs(r2_3_2 - r2_3_1) #xung của động cơ 2 sau các khoảng thời gian đọc được
        # print("xungdc2 sau mot khoang thoi gian la:",xungdc2)             
        # r2_3_1 = r2_3_2
